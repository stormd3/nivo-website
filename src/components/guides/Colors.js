                ...
                <div className="page_content">
                    ...
                    <div className="text-content guide-description">
                        ...
                        <div className="intro">
                            <p className="description">
                                Beside highlighting data insights, your dataviz should be pretty,
                                right ?<br />
                                nivo provides an easy way to deal with colors, very useful when
                    ...
                    */}
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p>
                                                looks familiar isn't it, obviously it's the
                                                categorical colors used on this doc.
                                            </p>
                        ...
                        <div className="grid_item grid_item-full">
                            ...
                            <p className="description">
                                A lot of components have a <code>*Color</code> property, but what
                                can we pass to it ?
                            </p>
                        </div>
